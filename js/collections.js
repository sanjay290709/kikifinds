/* ============================================================
   ...
   Filter pill interactions + Sort Dropdown + Quick View + formatting
   ============================================================ */
(function () {
  'use strict';
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderProducts(filter, sort = 'default') {
      ...
      // Add Quick View click handlers
      grid.querySelectorAll('.quickview-card-btn').forEach(btn => {
        btn.addEventListener('click', (e) => {
          e.preventDefault();
          e.stopPropagation();
      ...
      if (window._cursorHover) {
        grid.querySelectorAll('.product-card, .wishlist-btn, .btn-add-cart, .quickview-card-btn').forEach(window._cursorHover);
      }
    }

    window.refreshCollectionsGrid = () => renderProducts(activeFilter, activeSort);
    renderProducts(activeFilter, activeSort);
  });
